...
CREATE_STATION_INFORMATION_AND_STATUS_FIELDS_TABLE = """
    CREATE TABLE IF NOT EXISTS station_information_and_status_fields (
        data_time_stamp TIMESTAMPTZ DEFAULT NOT NULL,
        sensor_index INT DEFAULT NOT NULL,
        ...
        position_rating INT DEFAULT NULL,
        led_brightness INT DEFAULT NULL,
        firmware_version TEXT DEFAULT NULL,
        firmware_upgrade TEXT DEFAULT NULL,
        rssi INT DEFAULT NULL,
        uptime INT DEFAULT NULL,
        pa_latency INT DEFAULT NULL,
        memory INT DEFAULT NULL,
        last_seen TIMESTAMPTZ DEFAULT NULL,
        last_modified TIMESTAMPTZ DEFAULT NULL,
        date_created TIMESTAMPTZ DEFAULT NULL,
        channel_state INT DEFAULT NULL,
        channel_flags INT DEFAULT NULL,
        channel_flags_manual INT DEFAULT NULL,
        channel_flags_auto INT DEFAULT NULL,
        confidence INT DEFAULT NULL,
        confidence_manual INT DEFAULT NULL,
        confidence_auto INT DEFAULT NULL,
...
CREATE_ENVIRONMENTAL_FIELDS_TABLE = """
    CREATE TABLE IF NOT EXISTS environmental_fields (
        ...
        humidity_a INT DEFAULT NULL,
        humidity_b INT DEFAULT NULL,
        temperature INT DEFAULT NULL,
        temperature_a INT DEFAULT NULL,
        temperature_b INT DEFAULT NULL,
        pressure FLOAT DEFAULT NULL,
        pressure_a FLOAT DEFAULT NULL,
        pressure_b FLOAT DEFAULT NULL,
        PRIMARY KEY(data_time_stamp, sensor_index))"""
...
CREATE_MISCELLANEOUS_FIELDS = """
    CREATE TABLE IF NOT EXISTS miscellaneous_fields (
        ...
        voc_a FLOAT DEFAULT NULL,
        voc_b FLOAT DEFAULT NULL,
        ozone1 FLOAT DEFAULT NULL,
        analog_input FLOAT DEFAULT NULL,
        PRIMARY KEY(data_time_stamp, sensor_index))"""
...
CREATE_PM1_0_FIELDS = """
    CREATE TABLE IF NOT EXISTS pm1_0_fields(
        ...
        pm1_0_a FLOAT DEFAULT NULL,
        pm1_0_b FLOAT DEFAULT NULL,
        pm1_0_atm FLOAT DEFAULT NULL,
        pm1_0_atm_a FLOAT DEFAULT NULL,
        pm1_0_atm_b FLOAT DEFAULT NULL,
        pm1_0_cf_1 FLOAT DEFAULT NULL,
        pm1_0_cf_1_a FLOAT DEFAULT NULL,
        pm1_0_cf_1_b FLOAT DEFAULT NULL,
        PRIMARY KEY(data_time_stamp, sensor_index))"""
...
CREATE_PM2_5_FIELDS = """
    CREATE TABLE IF NOT EXISTS pm2_5_fields (
        data_time_stamp TIMESTAMPTZ DEFAULT NOT NULL,
        sensor_index INT DEFAULT NOT NULL,
        pm2_5_alt FLOAT DEFAULT NULL,
        pm2_5_alt_a FLOAT DEFAULT NULL,
        pm2_5_alt_b FLOAT DEFAULT NULL,
        pm2_5 FLOAT DEFAULT NULL,
        pm2_5_a FLOAT DEFAULT NULL,
        pm2_5_b FLOAT DEFAULT NULL,
        pm2_5_atm FLOAT DEFAULT NULL,
        pm2_5_atm_a FLOAT DEFAULT NULL,
        pm2_5_atm_b FLOAT DEFAULT NULL,
        pm2_5_cf_1 FLOAT DEFAULT NULL,
        pm2_5_cf_1_a FLOAT DEFAULT NULL,
        pm2_5_cf_1_b FLOAT DEFAULT NULL,
        PRIMARY KEY(data_time_stamp, sensor_index))"""
...
CREATE_PM2_5_PSEUDO_AVERAGE_FIELDS = """
    CREATE TABLE IF NOT EXISTS pm2_5_pseudo_average_fields (
        data_time_stamp TIMESTAMPTZ DEFAULT NOT NULL,
        sensor_index INT DEFAULT NOT NULL,
        pm2_5_10minute FLOAT DEFAULT NULL,
        pm2_5_10minute_a FLOAT DEFAULT NULL,
        pm2_5_10minute_b FLOAT DEFAULT NULL,
        pm2_5_30minute FLOAT DEFAULT NULL,
        pm2_5_30minute_a FLOAT DEFAULT NULL,
        pm2_5_30minute_b FLOAT DEFAULT NULL,
        pm2_5_60minute FLOAT DEFAULT NULL,
        pm2_5_60minute_a FLOAT DEFAULT NULL,
        pm2_5_60minute_b FLOAT DEFAULT NULL,
        pm2_5_6hour FLOAT DEFAULT NULL,
        pm2_5_6hour_a FLOAT DEFAULT NULL,
        pm2_5_6hour_b FLOAT DEFAULT NULL,
        pm2_5_24hour FLOAT DEFAULT NULL,
        pm2_5_24hour_a FLOAT DEFAULT NULL,
        pm2_5_24hour_b FLOAT DEFAULT NULL,
        pm2_5_1week FLOAT DEFAULT NULL,
        pm2_5_1week_a FLOAT DEFAULT NULL,
        pm2_5_1week_b FLOAT DEFAULT NULL,
        PRIMARY KEY(data_time_stamp, sensor_index))"""
...
CREATE_PM10_0_FIELDS = """
    CREATE TABLE IF NOT EXISTS pm10_0_fields (
        ...
        pm10_0_a FLOAT DEFAULT NULL,
        pm10_0_b FLOAT DEFAULT NULL,
        pm10_0_atm FLOAT DEFAULT NULL,
        pm10_0_atm_a FLOAT DEFAULT NULL,
        pm10_0_atm_b FLOAT DEFAULT NULL,
        pm10_0_cf_1 FLOAT DEFAULT NULL,
        pm10_0_cf_1_a FLOAT DEFAULT NULL,
        pm10_0_cf_1_b FLOAT DEFAULT NULL,
        PRIMARY KEY(data_time_stamp, sensor_index))"""
...
CREATE_PARTICLE_COUNT_FIELDS = """
    CREATE TABLE IF NOT EXISTS particle_count_fields (
        data_time_stamp TIMESTAMPTZ DEFAULT NOT NULL,
        sensor_index INT DEFAULT NOT NULL,
        um_count_0_3 FLOAT DEFAULT NULL,
        um_count_a_0_3 FLOAT DEFAULT NULL,
        um_count_b_0_3 FLOAT DEFAULT NULL,
        um_count_0_5 FLOAT DEFAULT NULL,
        um_count_a_0_5 FLOAT DEFAULT NULL,
        um_count_b_0_5 FLOAT DEFAULT NULL,
        um_count_1_0 FLOAT DEFAULT NULL,
        um_count_a_1_0 FLOAT DEFAULT NULL,
        um_count_b_1_0 FLOAT DEFAULT NULL,
        um_count_2_5 FLOAT DEFAULT NULL,
        um_count_a_2_5 FLOAT DEFAULT NULL,
        um_count_b_2_5 FLOAT DEFAULT NULL,
        um_count_5_0 FLOAT DEFAULT NULL,
        um_count_a_5_0 FLOAT DEFAULT NULL,
        um_count_b_5_0 FLOAT DEFAULT NULL,
        um_count_10_0 FLOAT DEFAULT NULL,
        um_count_a_10_0 FLOAT DEFAULT NULL,
        um_count_b_10_0 FLOAT DEFAULT NULL,
        PRIMARY KEY(data_time_stamp, sensor_index))"""
...
CREATE_THINGSPEAK_FIELDS = """
    CREATE TABLE IF NOT EXISTS thingspeak_fields (
        data_time_stamp TIMESTAMPTZ DEFAULT NOT NULL,
        sensor_index INT DEFAULT NOT NULL,
        primary_id_a INT DEFAULT NULL,
        primary_key_a TEXT DEFAULT NULL,
        secondary_id_a INT DEFAULT NULL,
        secondary_key_a TEXT DEFAULT NULL,
        primary_id_b INT DEFAULT NULL,
        primary_key_b TEXT DEFAULT NULL,
        secondary_id_b INT DEFAULT NULL,
        secondary_key_b TEXT DEFAULT NULL,
        PRIMARY KEY(data_time_stamp, sensor_index))"""
